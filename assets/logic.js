// // Example queryURL for Giphy API
 ...
 $(document).ready(function() {
	...
	var topics = ["kristen wiig", "kate mckinnon", "aidy bryant", "molly shannon", 
	"leslie jones", "tina fey", "amy poehler", "maya rudolph", "rachel dratch" ];
	...
	// ***** FUNCTIONS *****
		...
		$("#topicButtons").on("click","button", function() {
			...
			characterName = $(this).attr("name") + "saturday night live";
